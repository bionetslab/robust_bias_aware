...
def _get_parser():
    ...
    parser.add_argument('--study-bias-scores', type=str, default='NONE', choices=['NONE', 'BAIT_USAGE', 'STUDY_ATTENTION', 'CUSTOM'], help='Specifies edge weight function used by ROBUST')
