...
def update_networks():
    ...
    # 'STRING', 'HIPPIE' and 'HuRI' often throw network errors (especially at line 'ndex2.create_nice_cx_from_raw_cx')-this is an ndex server issue.
    # That is why these three datasets have been run in try-catch blocks of upto 3 failed attempts.
