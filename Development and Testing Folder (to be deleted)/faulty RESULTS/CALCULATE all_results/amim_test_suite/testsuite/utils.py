...
class NodeNamespaceSelector(Enum):
...
def get_normalize(normalize_selector):
    if normalize_selector == NormalizeSelector.UNIFORM:
        return 'UNIFORM'
    elif normalize_selector == NormalizeSelector.BAIT_USAGE:
        return 'BAIT_USAGE'
    elif normalize_selector == NormalizeSelector.PAIR_FREQ:
        return 'PAIR_FREQ'
    elif normalize_selector == NormalizeSelector.CUSTOM:
        return 'CUSTOM'
    
def get_lambdas(lambda_selector):
    if lambda_selector == LambdaSelector.L1:
        return 0.25
    elif lambda_selector == LambdaSelector.L2:
        return 0.50
    elif lambda_selector == LambdaSelector.L3:
        return 0.75
    elif lambda_selector == LambdaSelector.L4:
        return 1.00
