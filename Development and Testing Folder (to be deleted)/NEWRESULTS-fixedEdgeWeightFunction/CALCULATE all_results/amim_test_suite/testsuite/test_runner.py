...
class TestRunner(object):
    ...
    def run_on_network(self, ggi_network, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, seed, ggi_network_name, network_generator_name, condition_selector,
        ...
        result_genes, mean_degree = algorithm_wrapper.run_algorithm(ggi_network,  edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, expression_data, phenotypes,
    ...
    def run_on_original_network(self, ggi_network_selector, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, condition_selector, algorithm_selector, verbose):
        ...
        self.run_on_network(ggi_network, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, -1, ggi_network_name, network_generator_name, condition_selector, algorithm_selector, verbose)

    def run_on_random_networks(self, ggi_network_selector, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, condition_selector, network_generator_selector,
                               algorithm_selector, verbose):
        ...
        for seed in seeds:
            ...
            self.run_on_network(ggi_network, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, seed, ggi_network_name, network_generator_name, condition_selector, algorithm_selector, verbose)
    ...
    def run_all(self, ggi_network_selector, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, network_generator_selector, algorithm_selector, condition_selectors, verbose):
        """Runs all tests.
        ...
        for condition_selector in condition_selectors:
            ...
            if network_generator_selector == utils.NetworkGeneratorSelector.ORIGINAL:
                self.run_on_original_network(ggi_network_selector, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, condition_selector, algorithm_selector, verbose)
            else:
                self.run_on_random_networks(ggi_network_selector, edge_cost_selector, node_namespace_selector, normalize_selector, lambda_selector, condition_selector, network_generator_selector, algorithm_selector, verbose)
