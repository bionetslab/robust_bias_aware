...
res_0point00=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-0.00.csv')
res_0point00['lambda']=0.00

res_0point25=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-0.25.csv')
res_0point25['lambda']=0.25

res_0point50=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-0.50.csv')
res_0point50['lambda']=0.50

res_0point75=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-0.75.csv')
res_0point75['lambda']=0.75

res_1point00=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-1.00.csv')
res_1point00['lambda']=1.00

res_1point5=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-1.5.csv')
res_1point5['lambda']=1.50

res_2point0=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-2.0.csv')
res_2point0['lambda']=2.00

res_2point5=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-2.5.csv')
res_2point5['lambda']=2.50

res_3point0=pd.read_csv('/Users/surya/Documents/RECORDRESULTS_STUDYBIAS/RESULTS/2. EXPONENTIAL/BAIT_USAGE/RESULTS-SUMMARIZED/all_results-3.0.csv')
res_3point0['lambda']=3.00

res = pd.concat([res_0point00, res_0point25, res_0point50, res_0point75, res_1point00, res_1point5, res_2point0, res_2point5, res_3point0])
...
ax5.set_xticklabels([0.00, 0.25, 0.50, 0.75, 1.00, 1.50, 2.00, 2.50, 3.00], rotation = 90)
